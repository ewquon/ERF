...
- the dynamic viscosity in the momentum equation is assumed to have the form :math:`\mu = \rho \alpha_M`
  ...
  this diffusivity is multiplied by the instantaneous density :math:`\rho` to form the coefficient in the momentum equation; and

- ``erf.alpha_T`` is multiplied by the instantaneous density :math:`\rho` to form the coefficient for potential temperature, and

- ``erf.alpha_C`` is multiplied by the instantaneous density :math:`\rho` to form the coefficient for an advected scalar.
